$(document).ready(function(){
    ...
    $.getJSON(myUrl,function(data){
      ...
      $(".change-scale").on("click",function(){
        ...
        $(".temp-view").addClass("animated fadeInLeftBig");
        window.setTimeout(function (){
         $(".temp-view").removeClass("animated fadeInLeftBig"); 
        },2000);
      ...
      $('.change-scale').each(function() {
            animationHover(this, 'bounceIn',$(".temp-view"));
        });
      });
    function animationHover(element, animation ,target){
        element = $(element);
        element.hover(
            function() {
